...
const DetailsArtist = ({
  ...
  useGSAP(() => {
    timeline.current = gsap
      ...
      .to(closeButtonRef.current, { scale: 1, opacity: 1, duration: 0.3, ease: 'power2.inOut' });
  }, [artist]);
  ...
  return (
    ...
    >
      <div className="sticky top-[108px] z-40 flex w-full justify-end px-x-default">
        <div ref={closeButtonRef} className="scale-0">
        ...
        <div className="flex w-full flex-col gap-24 pb-24">
          ...
          {artist.events && (
            <div>
              ...
              <div ref={sliderRef} className="flex w-full gap-4 overflow-x-scroll px-x-default">
